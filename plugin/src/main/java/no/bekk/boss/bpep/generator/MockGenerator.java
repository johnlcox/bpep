...
public class MockGenerator implements Generator {
    ...
    public void generate(ICompilationUnit compilationUnit, boolean createPrivateConstructor, boolean formatSource, List<IField> selectedFields, boolean addValidation) {
        try {
